"""DIPVAE_model.py: Tensorflow model for the VAutoencoder"""
...
from .DIPVAE_graph import DIPVAEGraph
from .DIPVAECNN_graph import DIPVAECNNGraph
    ...
    def train(self, data_train, data_valid, enable_es=1):
        ...
        with tf.Session(graph=self.graph) as session:
            ...
            for cur_epoch in range(self.model_graph.cur_epoch_tensor.eval(session), self.epochs + 1, 1):
                ...
                print('TRAIN | DIPVAE Loss: ', vae_tr, 'AE Loss: ', ae_tr, ' | Recons: ', recons_tr)
                print('      | KL-div: ', kl_tr, ' | L2_loss: ', L2_loss_tr)

                print('VALID | DIPVAE Loss: ', vae_val, 'AE Loss: ', ae_val, ' | Recons: ', recons_val)
