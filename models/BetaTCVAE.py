...
class BetaVAE(AE_BASE):
    ...
    def _build(self):
        ...
        self.model = BetaVAEModel(network_params=self.network_params, act_out=utils.softplus_bias, sigma=self.config.sigma,
